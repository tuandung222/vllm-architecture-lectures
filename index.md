...
0.1. **Bài 0.1: Cấu tạo Phần cứng GPU & Bản chất Vật lý của Prefill/Decode**  
   *Chi tiết phần cứng GPU (SMs, Tensor Cores, HBM, SRAM), SIMT, Roofline Model và phân tích vật lý của prefill/decode bottlenecks.*  
   👉 [Đọc Bài 0.1](docs/lesson_0_gpu_hardware.html)
...
7.1. **Bài 7.1: Chi tiết Lượng hóa – Weight-Only (AWQ) vs Activation Quantization**  
   *Lý thuyết lượng hóa mô hình, dequantization trên SRAM, cơ chế AWQ bảo vệ salient weights, lỗi outliers và lợi ích lượng hóa FP8/W8A8/KV Cache.*  
   👉 [Đọc Bài 7.1](docs/lesson_7_quantization_deep_dive.html)
