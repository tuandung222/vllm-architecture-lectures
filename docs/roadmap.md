...
| **Bài 10** | **Quản lý VRAM & Chiến lược Lập lịch Offline Batching** | Cơ chế phân bổ VRAM tĩnh, profiling run xác định activation memory, Scheduler concurrency limits và kinh nghiệm làm dữ liệu hàng loạt. | [Bài 10 Docs](./10_production_reference/lesson_10_vram_allocation_offline_batching.md) |
